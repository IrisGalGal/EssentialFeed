...
public final class ImageCommentsPresenter{
    ...
    public static func map(
        ...
        return ImageCommentsViewModel(comments: comments.map { commment in
            ImageCommentViewModel(
                message: commment.message,
                date: formatter.localizedString(for: commment.createdAt, relativeTo: currentDate),
